...
1. Start with a short [Overview](overview) of the library's main components
   to get a better high-level understanding.
1. Install the library following instructions in the [Installation](installation)
   section.
1. If you want to use the library for your own use-case, choose the framework
   you want to use (e.g. [Keras](keras_api.rst) or
   [JAX & Flax](core_library.rst)) and study its API capabilities with the
   provided examples.
...
1. If you want to contribute to the library, navigate to the
