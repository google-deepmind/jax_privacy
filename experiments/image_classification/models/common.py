...
def restore_from_path(
  ...
  Returns:
    params: model parameters loaded from the checkpoint.
    network_state: model state loaded from the checkpoint.
  """
  ...
  return ckpt_state[params_key], ckpt_state[network_state_key]
