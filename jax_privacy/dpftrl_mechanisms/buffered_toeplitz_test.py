...
# TODO: b/410503399 - Fix timeouts in this test.
...
class OptimizationTest(parameterized.TestCase):
  ...
  # TODO: b/410502200 - Fix test failing in OSS release.
  @hypothesis.given(
      n_nbuf_rtol_tuple=st.sampled_from([
          ...
          (    100_000, 4, 1.03),
          (  1_000_000, 5, 1.18),  # TODO: b/368661622 - Tighten rtol.
          ( 10_000_000, 2, 1.40),  # Too few buffers.
          ( 10_000_000, 4, 1.06),
          ( 10_000_000, 6, 1.17),  # TODO: b/368661622 - Tighten rtol.
          ( 10_000_000, 8, 1.10),
          (100_000_000, 2, 1.60),  # Too few buffers.
          (100_000_000, 7, 1.53),
          # TODO: b/368661622 - Tighten rtol.
          # pyformat: enable
