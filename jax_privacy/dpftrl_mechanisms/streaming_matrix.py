...
class StreamingMatrix:
  ...
  in streaming fashion. The precise meaning of this efficiency is
  implementation-dependent, with examples including constant memory overhead,
  and / or without fully materializing A or x.
