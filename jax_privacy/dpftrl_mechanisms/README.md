...
:                      :                 : $$A$$.                            :
| `max_participations` | k               | The number of epochs or maximum   |
...
:               :                      : [Banded'23][Banded23].          :
| `fixed_epoch` | $$(k, b)$$           | There are exactly $$n = k \cdot |
:               : participation        : b$$ iterations, and client      :
:               :                      : participations are separated by :
:               :                      : multiples of exactly $$b$$\: if :
:               :                      : a client participates on        :
:               :                      : iterations $$i$$ and $$j$$,     :
:               :                      : then $$|i - j| % b = 0$$. See   :
:               :                      : [MultiEpoch'23][MultiEpoch23]   :
...
Introduced in [Banded'23][Banded23].
...
See [`toeplitz.py`](../toeplitz.py). Structure $$C \in R^{n \times n}$$
