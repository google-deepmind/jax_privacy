...
class Experiment(experiment.AbstractExperiment):
    ...
    def _model_fn(self, inputs, is_training=False):
        ...
        model_instance = models.get_model_instance(
            self.config.model.model_type, self.config.model.model_kwargs
        )
    ...
    def _initialize_train(self):
        ...
        if self._params is None:
            ...
            if self.config.model.restore.path:
                ...
                logging.info(
                    "Initialized parameters randomly rather than restoring "
                    "from checkpoint."
                )
