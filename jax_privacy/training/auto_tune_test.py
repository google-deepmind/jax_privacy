...
class AutoTuneTest(parameterized.TestCase):
  ...
  def test_tune_noise_multiplier(self, accountant_name, num_examples_per_user):
  ...
  def test_tune_num_updates(self, accountant_name, num_examples_per_user):
    config_ref = get_config(
  ...
  # user level accounting is supported only for PLD.
  @parameterized.parameters(
      ('rdp', None), ('pld', None), ('pld', 1), ('pld', 2)
  )
  def test_tune_epsilon(self, accountant_name, num_examples_per_user):
    config_ref = get_config(
  ...
  def test_tune_batch_size(self, accountant_name, num_examples_per_user):
    config_ref = get_config(
