...
-   **Keras Gemma examples `train_steps`**: Count optimizer updates
    (`epochs * (train_size // effective_batch_size)`) instead of micro-batches,
    matching `DPKerasConfig` and the privacy accountant.
